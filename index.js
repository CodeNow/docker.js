  ...
  return (function (host) {
    ...
    function genFunction(o) {
      ...
      return function(opts, id, cb) {
        ...
        if (typeof(opts) === 'function') {
          ...
          request({url: url, json: true, method:method, headers: {token: token}}, function(err, res, json) {
        ...
        // returns request for streaming
          ...
          var url = resolve(host, path)
          return request({url: url, json: opts, method: method, pool: false, headers: {token: token}})
        }
        ...
        // Signature: function(opts, cb)
          ...
          var url = resolve(host, path)
          request({url: url, json: opts, method: method, pool: false, headers: {token: token}}, function(err, res, json) {
            return checkStatus(err, res, json, cb)
          })
        }
        ...
        // Signature: function(id, cb)
          ...
          var url = resolve(host, path)
          request({url: url, json: true, method:method, pool: false, headers: {token: token}}, function(err, res, json) {
            return checkStatus(err, res, json, cb)
          })
        }
      }
    ...
    return {
      ...
      tagImage: genFunction({
        path: 'images/{{id}}/tag',
        method: 'POST',
        codes: {201:true, 400:"bad parameter", 404:"no such image", 500:"server error"}
      }),
